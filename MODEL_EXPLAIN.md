...
Обновление 2026-09-05: ниже описан уже опубликованный submission **Task11**.
Лучший локальный результат теперь у **Task13 D_all**: P20 all/labeled
`0.005077640992845437 / 0.006911912728855518`, 221 признак, включая20скаляров
близости к ALS-профилям истории, и свежие train-only границы квантования.
Полный пересчёт всех production моделей по этому рецепту подготовлен в Task14:
см. [PROFILE_FULL_FIT.md](PROFILE_FULL_FIT.md). Его большой запуск ещё предстоит;
старые модели Task11 в новый production fit не переносятся.
