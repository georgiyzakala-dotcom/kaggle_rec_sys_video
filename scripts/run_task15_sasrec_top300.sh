...
cd "${sasrec_repo}"
if [[ "${1:-}" == "--help" ]]; then
    exec .venv/bin/python scripts/run_sasrec_top300.py --help
fi
sasrec_config="${1:-configs/task15_sasrec_top300_v1.json}"
if (( $# > 0 )); then shift; fi
